        ...
        const items = [
          {
            ...
            fn: () => {
              const el = document.querySelector(
                '[data-test-selector="community-points-summary"] button, button[aria-label*="Channel Points"i]',
              )
              if (el) el.click()
            },
          ...
          },
          {
            ...
            fn: () => {
              const el = document.querySelector(
                '[data-a-target="bits-button"], [aria-label*="Cheer with Bits"i], [aria-label*="Get Bits"i]',
              )
              if (el) el.click()
            },
            disabled: !document.querySelector(
          ...
          },
          {
            ...
            fn: () => {
              const el = document.querySelector(
                '[data-test-selector*="prediction"i] button, [aria-label*="Prediction"i]',
              )
              if (el) el.click()
            },
            disabled: !document.querySelector(
